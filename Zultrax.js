...
(function() {
  var Asteroid, BasicFrame, Bullet, CIRCLE, DYNAMIC, Entity, Frame, Game, KEY_DOWN_ARROW, KEY_LEFT_SHIFT, KEY_SPACE, KEY_UP_ARROW, Missile, Mobile, NON_OPERATOR, NON_PHYSICAL, OPERATOR, Player, PlayerAnimation, Portal, RECTANGLE, STATIC, Wall, pointInRect, pointWithin, start,
  ...
  Frame = (function() {
    ...
    Frame.prototype.run = function(elapsedTime, context, events, mousex, mousey) {
      return this.simulateWorld(elapsedTime, context, events, mousex, mousey);
    };

    Frame.prototype.simulateWorld = function(elapsedTime, context, events, mousex, mousey) {
    ...
    Frame.prototype.physicalCollide = function(partner1, partner2) {
      ...
      if (partner1.hitboxType === RECTANGLE || partner2.hitboxType === RECTANGLE) {
        ...
        return partner2.yVelocity = newVelY2 * dampeningFactor;
      }
    };
  ...
  Entity = (function() {
    ...
    Entity.prototype.run = function(elapsedTime) {};
  ...
  Portal = (function(_super) {
    ...
    function Portal(_map, _id, _graphics, _x, _y, _exit, _frame, halfWidth, halfHeight) {
      this.halfWidth = halfWidth;
      this.halfHeight = halfHeight;
